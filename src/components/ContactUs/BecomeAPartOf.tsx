...
const BecomeAPartOf = () => {
  return (
    <>
      <div className="w-full h-[1383px] flex flex-col items-center max-custom:h-[789.15px] max-mid:h-[528px]">
        {/* Text + Photo */}
        <div className="w-[1440px] h-[812px] pt-[92px] pb-[80px] flex flex-col justify-between items-center max-custom:h-[480.29px] max-custom:w-[764px] max-custom:pt-[91.13px] max-custom:pb-[43.3px] max-mid:w-[320px] max-mid:h-[284px] max-mid:p-0 max-mid:pb-[40px]">
          {/* text */}
